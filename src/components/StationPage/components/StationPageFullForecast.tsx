import { timeOnlyUtil, fullDateNoTime, dayWithNameUtilWithCustom } from "@/utils/dateTimeUtils";
...
export default function StationFullForecast({ stationForecast }: StationFullForecastProps) {
    ...
    const structuredForecast = stationForecast.full_forecast.reduce(
        (acc: GroupedWeatherData, currentItem) => {
    ...
    return (
        <section>
            ...
            <div className="my-2 h-fit">
                            ...
                            shouldRenderForecast && (
                                ...
                                >
                                    ...
                                    <p className="text-primary">
                                        ...
                                        <span className="ml-1 text-sm">{Measurements.CELCIUS}</span>
                                    </p>
                ...
                {stationForecast.full_forecast.length === 0 && (
