    ...
    return [
        columnHelper.accessor((row) => row.date_created, {
            ...
            cell: (info) => {
                return (
                    <p>
                        {fullDateNoTime(info.getValue())}{" "}
                        <span className="block opacity-60">{timeOnlyUtil(info.getValue())}</span>
                    </p>
                );
            },
            header: () => (
                <p>{i18n.getFixedT(selectedLanguage, "warnings")("tableData.dateCreated")}</p>
            ),
        }),
        columnHelper.accessor((row) => row.warning_location_id.label, {
            ...
            header: () => (
                <span>{i18n.getFixedT(selectedLanguage, "warnings")("tableData.location")}</span>
            ),
        }),
            ...
            cell: (info) => (
                <div className="flex items-center gap-2">
                    <div
                        ...
                        style={{ backgroundColor: info.getValue().color }}
                    ></div>
                    <p>{info.getValue().label}</p>
                </div>
            ),
            header: () => (
                <span>
                    {i18n.getFixedT(selectedLanguage, "warnings")("tableData.warningLevel")}
                </span>
            ),
        }),
        columnHelper.accessor((row) => row.hazard_id, {
            ...
            header: () => (
                <span>
                    {i18n.getFixedT(selectedLanguage, "warnings")("tableData.warningHazard")}
                </span>
            ),
        ...
        columnHelper.accessor((row) => row[descriptionColumnId], {
            ...
            header: () => (
                <span>
                    {i18n.getFixedT(selectedLanguage, "warnings")("tableData.warningDescription")}
                </span>
            ),
            enableSorting: false,
        }),
        columnHelper.accessor((row) => row.start_date, {
            ...
            header: () => (
                <p>{i18n.getFixedT(selectedLanguage, "warnings")("tableData.startingTime")}</p>
            ),
            enableSorting: false,
        }),
        columnHelper.accessor((row) => row.end_date, {
            ...
            header: () => (
                <p>{i18n.getFixedT(selectedLanguage, "warnings")("tableData.endingTime")}</p>
            ),
            enableSorting: false,
        }),
        columnHelper.accessor((row) => row.meteoalarm_warning_id, {
            ...
            header: () => (
                <span>{i18n.getFixedT(selectedLanguage, "warnings")("tableData.issuedBy")}</span>
            ),
            enableSorting: false,
        }),
    ];
